...
#Parameters list
params=['Non-Penalty Goals','npxG','Assists','xAG','Shot-Creating\n Actions',
        'Pass Completion\n (as a%)','Progressive\n Passes','Progressive\n Carries','Successful\n Take-Ons','Progressive Passes\n Received',
        'Tackles','Interceptions','Blocks','Clearances','Aerials\n Won']

#Value list
#Taken from FBREF site
reinildo_values=[30,13,20,1,1,74,53,43,45,14,59,88,45,89,59]
...
fig, ax = baker.make_pizza(
    reinildo_values,                          # list of values
...
#Add title
fig_text(
    0.515, 1.01, "Reinildo Mandava - Sunderland AFC",
    size=16, fig=fig,
...
fig_text(
    0.5, 0.98,
    "Percentile Rank vs League Fullbacks | Season 2025-26",
    size=13, fig=fig,
    ha="center", color="#F2F2F2"
)
...
#Add Reinildo Mandava image
# Add Reinildo Mandava image as a circle
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Reinildo Mandava/Reinildo.png')
...
#Add Sunderland badge
ax8=fig.add_axes([0.90,0.89,0.1,0.13])
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Reinildo Mandava/sunderland_logo.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Reinildo Mandava/Reinildo matrix.png', dpi=300, bbox_inches='tight')
