...
diouf_values=[30,36,85,34,17,20,15,25,66,46,3,56,29,87,52]
...
#Add title
fig_text(
    0.515, 1.01, "Malick Diouf - West Ham United",
    size=16, fig=fig,
...
#Add Malick Diouf image
# Add Malick Diouf image as a circle
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Malick Diouf/Malick Diouf.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Malick Diouf/West Ham logo.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Malick Diouf/Diouf matrix.png', dpi=300, bbox_inches='tight')
