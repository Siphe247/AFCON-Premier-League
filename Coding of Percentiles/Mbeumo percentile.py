...
mbeumo_values=[89,91,24,75,70,47,45,50,27,78,22,22,32,7,30]
...
#Add title
fig_text(
    0.515, 1.01, "Bryan Mbeumo - Manchester United",
    size=16, fig=fig,
...
#Add Bryan Mbeumo image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Bryan Mbeumo/Mbeumo.png')
...
#Add Manchester United badge
ax8=fig.add_axes([0.90,0.89,0.1,0.13])
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Bryan Mbeumo/manchester utd_logo.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Bryan Mbeumo/Mbeumo matrix.png', dpi=300, bbox_inches='tight')
