...
ndiaye_values=[56,38,51,60,30,71,12,69,86,48,90,35,51,48,23]
...
#Add title
fig_text(
    0.515, 1.01, "Iliman Ndiaye - Everton",
    size=16, fig=fig,
...
#Add Iliman Ndiaye image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Iliman Ndiaye/Ndiaye.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Iliman Ndiaye/Everton.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Iliman Ndiaye/Ndiaye percentile.png', dpi=300, bbox_inches='tight')
