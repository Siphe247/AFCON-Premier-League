...
gueye_values=[71,69,16,18,25,77,56,7,6,42,75,61,48,17,31]
...
#Add title
fig_text(
    0.515, 1.01, "Idrissa Gueye - Everton FC",
    size=16, fig=fig,
...
#Add Idrissa Gueye image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Idrissa Gueye/Gueye.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Idrissa Gueye/Everton.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Idrissa Gueye/Gueye percentile.png', dpi=300, bbox_inches='tight')
