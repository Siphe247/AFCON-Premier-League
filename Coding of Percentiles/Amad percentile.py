...
amad_values=[86,99,80,97,99,89,53,99,93,99,20,16,9,5,24]
...
#Add title
fig_text(
    0.515, 1.01, "Amad Diallo - Manchester United",
    size=16, fig=fig,
...
#Add Amad Diallo image
# Add Amad Diallo image as a circle
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Amad Diallo/Amad.png')
...
#Add Man United badge
ax8=fig.add_axes([0.90,0.89,0.1,0.13])
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Amad Diallo/Manchester Utd.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Amad Diallo/Amad percentile.png', dpi=300, bbox_inches='tight')
