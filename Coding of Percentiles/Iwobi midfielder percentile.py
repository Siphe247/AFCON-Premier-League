...
iwobi_values=[60,39,60,78,73,30,81,98,61,98,6,11,16,4,1]
...
baker = PyPizza(
    ...
    straight_line_color="#F8F9FA",  # color for straight lines
    straight_line_lw=1,             # linewidth for straight lines
    last_circle_color="#F8F9FA",    # color for last line
...
fig_text(
    0.5, 0.98,
    "Percentile Rank vs League Midfielders| Season 2025-26",
    size=13, fig=fig,
    ha="center", color="#000000"
)
...
#Add Alex Iwobi image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Alex Iwobi/Iwobi.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Alex Iwobi/Fulham.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Alex Iwobi/Iwobi CDM percentile.png', dpi=300, bbox_inches='tight')
