...
params=['Non-Penalty Goals','npxG','Assists','xAG','Shot-Creating\n Actions',
        ...
        'Interceptions','Blocks','Clearances','Aerials\n Won']

#Value list
#Taken from FBREF site
sadiki_values=[19,11,17,19,21,58,9,83,84,63,13,71,84,61,3]
...
#Add title
fig_text(
    0.515, 1.01, "Noah Sadiki - Sunderland AFC",
    size=16, fig=fig,
...
fig_text(
    0.5, 0.98,
    "Percentile Rank vs Top-Five League Midfielders | Season 2025-26",
    size=13, fig=fig,
    ha="center", color="#F2F2F2"
)
...
#Add Noah Sadiki image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Noah Sadiki/Noah Sadiki.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Noah Sadiki/sunderland_logo.png')
ax8.imshow(img)

plt.savefig('//Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Sadiki matrix.png', dpi=300, bbox_inches='tight')
