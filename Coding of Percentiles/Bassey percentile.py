...
bassey_values=[66,54,38,17,80,57,59,96,91,46,80,16,73,25,16]
...
#Add title
fig_text(
    0.515, 1.01, "Calvin Bassey - Fulham",
    size=16, fig=fig,
...
fig_text(
    0.5, 0.98,
    "Percentile Rank vs League Centre Halves | Season 2025-26",
    size=13, fig=fig,
    ha="center", color="#F2F2F2"
)
...
#Add Calvin Bassey image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Calvin Bassey/Calvin Bassey.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Calvin Bassey/Fulham.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Calvin Bassey/Bassey percentile.png', dpi=300, bbox_inches='tight')
