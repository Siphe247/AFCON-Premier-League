...
salah_values=[65,78,81,78,80,24,78,78,40,94,1,14,10,2,44]
...
#Add title
fig_text(
    0.515, 1.01, "Mohamed Salah - Liverpool",
    size=16, fig=fig,
...
#Add Mohamed Salah image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Mohamed Salah/Salah.png')
...
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Mohamed Salah/Liverpool.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Mohamed Salah/Salah percentile.png', dpi=300, bbox_inches='tight')