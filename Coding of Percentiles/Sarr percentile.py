...
sarr_values=[71,93,34,13,13,18,42,55,2,28,20,64,55,90,83]
...
#Add title
fig_text(
    0.515, 1.01, "Ismaila Sarr - Crystal Palace",
    size=16, fig=fig,
...
#Add Ismaila Sarr image
ax1 = fig.add_axes([0.4478, 0.4315, 0.13, 0.13])  # make width & height equal for a circle
ax1.axis('off')

# open and make circular
img = Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Ismaila Sarr/Sarr.png')
...
#Add Crystal Palace badge
ax8=fig.add_axes([0.90,0.89,0.1,0.13])
ax8.axis('off')
img=Image.open('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Ismaila Sarr/crystal palace_logo.png')
ax8.imshow(img)

plt.savefig('/Users/siphuvuyomngxunyeni/Downloads/Football Analytics/AFCON/Ismaila Sarr/Sarr percentile.png', dpi=300, bbox_inches='tight')
